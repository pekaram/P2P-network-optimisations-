...
namespace Photon.Pun
{
    ...
    public static partial class PhotonNetwork
    {
        ...
        public static GameObject Instantiate(string prefabName, Vector3 position, Quaternion rotation, byte group = 0, object[] data = null, bool send = true)
        {
            if (CurrentRoom == null)
            {
            ...
            return NetworkInstantiate(netParams, false, false, true);
        }
        ...
        private static GameObject NetworkInstantiate(Pun.InstantiateParameters parameters, bool sceneObject = false, bool instantiateEvent = false, bool send = true)
        {
